...
def plot_learning_curve(logfile_dir, result_lists):
    ...
    ################################################################
    plt.figure(0)
    plt.plot(range(0, len(result_lists['train_acc'])), result_lists['train_acc'])
    plt.title('train acc')
    ...
    plt.figure(1)
    plt.plot(range(0, len(result_lists['train_loss'])), result_lists['train_loss'])
    ...
    plt.figure(2)
    plt.plot(range(0, len(result_lists['val_acc'])), result_lists['val_acc'])
    plt.title('val acc')
    plt.xlabel('epoch'), plt.ylabel('acc')
    ...
    plt.figure(3)
    plt.plot(range(0, len(result_lists['val_loss'])), result_lists['val_loss'])
    plt.title('val loss')
    plt.xlabel('epoch'), plt.ylabel('loss')
